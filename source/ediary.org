...
* TODO 修复 offlineimap 无法收邮件的问题                              :linux:
...
** 诊断问题
   ...
   #+begin_example
     ...
     ...
      [imap]:   34:31.28 imap.xxxxxx.com reader socket error: <class 'socket.error'> - [Errno 104] Connection reset by peer
     ...
   #+end_example
