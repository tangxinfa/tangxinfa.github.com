...
** 定期清理日志
   ...
   不建议使用 [[https://www.npmjs.com/package/pm2-logrotate][pm2-logrotate]] ，太多问题了（详见：[[blog.kankanan.com/article/63a75236-pm2-768465e55fd765874ef659275c0f.html#sec-1][控制pm2的日志文件大小]]），还是使用 logrotate 服务靠谱（参见 [[http://pm2.keymetrics.io/docs/usage/log-management/#setting-up-a-native-logrotate][Setting up a native logrotate]]）。
