...
* DONE CentOS 6.4 生产环境上安装 pm2                             :node:linux:
  ...
  - 安装 LTS 版的 node.js
    ...
    #+begin_src sh
      wget http://npm.taobao.org/mirrors/node/latest-v4.x/node-v4.3.1-linux-x64.tar.xz
...
* DONE Rust 是 C++ 的继承者                                            :rust:
  ...
  考虑到 Rust 宣称是一门“安全”、“高效”、“并发”的语言，消除了大量 C++ 的缺陷，对于一个掌握 C++ 的开发人员来说，语法形式上添加的繁锁不是问题，只要是经得起推敲那就是合理的。
