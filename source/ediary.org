...
* TODO envoy 的熔断解决方案                                           :envoy:

  envoy 的弹性特性（Resiliency Features）包括

  - Timeouts

    网络调用的耗时是不可控的，必须设置超时时间。
  ...
  - [[https://www.envoyproxy.io/docs/envoy/latest/configuration/http/http_filters/fault_filter][Fault Injection]]
...
** 参考
   ...
   - [[https://developers.redhat.com/blog/2017/05/16/it-takes-more-than-a-circuit-breaker-to-create-a-resilient-application/][It takes more than a Circuit Breaker to create a resilient application -
     Red Hat Developer]]
...
** 下载 Bazel_and_CompileCommands
   ...
   #+begin_src sh
     git clone git@github.com:tangxinfa/Bazel_and_CompileCommands.git -b tangxinfa:fix-build-arguments
   #+end_src
