...
["at","[强æt, 弱ət] prep.[表示价格、速度等]以，达;在..方面"],
...
["bay","[bei] n.海湾,(港)湾"],
["be","[强bi:, 弱bi] v.(就)是，等于;(存)在;到达，来到，发生"],
...
["best","[best] a.最好的(good和well最高级) ad.最好地;最"],
...
["buy","[bai] vt.买，买得;向…行贿，收买vi.购买东西"],
["by","[bai] prep.被;凭借;经由;由于ad.在近旁;经过"],
...
["can","[强kæn, 弱kən] aux.v.能;可以 n.罐头;容器 vt.把…装罐"],
...
["celebrate","['selibreit] vt.庆祝;颂扬，赞美vi.庆祝，过节"],
...
["chance","[tʃɑ:ns, tʃæns] n.机会;可能性;偶然性,运气v.碰巧,偶然发生"],
...
["comic","['kɔmik] a.喜剧的，滑稽的n.连环漫画杂志;喜剧演员"],
...
["commonplace","['kɔmənpleis] a.普通的，平庸的n.寻常的事物，平庸的东西"],
...
["concrete","[kən'kri:t, 'kɔnkri:t] a.具体的,实质性的n.混凝土v.用混凝土修筑"],
...
["confine","[kən'fain, 'kɔnfain] vt.限制;使不外出，禁闭n.[pl.]界限，范围"],
...
["constituent","[kən'stitjuənt] n.选民;成分，组分a.组成的，构成的"],
...
["coordinate","[kəu'ɔ:dineit] a.同等的,并列的;坐标的 n.坐标"],
["coordinates","[kəu'ɔ:dineits] a.同等的 n.同等者,坐标 vt.协作，协调"],
["cop","n.警察(slang 俚语)"],
...
["do","[强du:, 弱du, du:] aux.v. vt.做，干，办，从事;引起 vi.行动"],
["dock","n.船坞,码头"],
...
["due","[dju:, du:] a.(to)应支付的;(车,船等)预定应到达的"],
...
["either","['aiðə, 'i:-] ad.也(不) pron.两者之一 a.(两者中)任一的"],
...
["fade","[feid, fad] v.褪色;衰减,消失n.淡入(出)n.乏味(平淡)的"],
...
["figure","['fiɡə] n.体形;轮廓;数字;图形v.描绘;计算;推测"],
...
["flatter","['fleivə] vt.奉承;使高兴;使满意;胜过"],
...
["for","[强 fɔ:, 弱fə] prep.为了;给;代替;向;支持 conj.因为?"],
...
["formation","['fɔ:mə] n.形成;构成;组织;构造;编制;塑造"],
...
["frog","[frɔɡ] n.蛙"],
["from","[强frɔm, 弱frəm] prep.从，自从;由于;离;根据，按;去除"],
...
["gas","[ɡæs] n.气体;煤气;汽油;毒气vt.毒(死);加油"],
...
["have","[hæv, 弱həv, əv, v] v.有，具有;体会，经受;从事;使;吃，喝"],
["hawk","[hɔ:k] n.鹰,隼"],
["hay","[hei] n.干草"],
...
["her","[hə:, 弱ə:, hə, ə] pron.[she的宾格]她;[she的所有格]她的"],
...
["hip","[hip] n.臀部，髋;屋脊"],
["hire","[haiə] n./v.雇用,租借"],
["his","[hiz, 弱iz] pron.[he的所有格/物主代词]他的(所有物)"],
...
["imperative","[im'perətiv] n.命令;需要;规则;祈使语气a.强制的;紧急的"],
...
["interest","['intrist, 'intər-] n.(in)兴趣,重要性;利益v.(in)使发生兴趣"],
...
["intrigue","[in'tri:ɡ, 'in-] n.阴谋v.密谋,私通;激起…的兴趣;诡计取得"],
...
["Latin","['lætitju:d] a.拉丁的,拉丁文的 n.拉丁语"],
...
["negative","['neɡətiv] a.否定的,消极的,阴性的n.负数;(摄影)底片"],
...
["nevertheless","[,nevəðə'les] conj.(nonetheless)然而,不过ad.仍然,不过"],
...
["otherwise","['ʌðəwaiz] ad.另样,用别的方法;在其他方面conj.要不然"],
["ought","[ɔ:t] aux.应该(使用时,之后应接to,再接动词原形)"],
["ounce","[auns] n.盎司,英两"],
["our","['auə, ɑ:] pron.[we的所有格]我们的"],
["ours","['auəz, 弱ɑ:z] pron.[we的物主代词]我们的(所有物)"],
...
["overwhelm","[,əuvə'hwelm] v.淹没,覆没,压倒,制服,使不知所措"],
...
["patent","['peitənt] a.专利的,特许的n.专利(权、品)v.批准专利"],
...
["plastic","['plæstik,'plɑ:s-] n.(常pl.)塑料,塑料制品 a.可塑的,塑性的"],
...
["play","[plei] v.玩，做游戏;参加比赛n.游戏;玩耍;剧本"],
...
["premise","[pri'maiz, 'premis] n.前提,房屋连地基v.提论,预述,假定"],
...
["privacy","['praivəsi, 'pri- 'prai-] n.(不受干扰的)独处，自由，隐私;私生活"],
["private","['praivit] a.私人的,个人的,秘密的,私下的"],
...
["process","['prəuses, 'prɔ-] n.过程,进程;工序,制作法;工艺 v.加工,处理"],
...
["project","['prɔdʒekt, prə'dʒekt] n.方案,工程,项目v.投射,放映;设计,规划"],
["projector","[prəu'dʒektə] n.放映机,幻灯机,投影仪"],
["prolong","[prə'lɔŋ, 'lɔ:ŋ] v.拉长,延长,拖延"],
...
["range","[reindʒ] n.范围,领域;排列,连续;(山)脉v.排列成行"],
...
["record","[ri'kɔ:d, 'rekɔ:d] n.记录;最高记录;履历;唱片v.记录;录音"],
...
["regard","[ri'ɡɑ:d, ri:-] v.(as)把…看作为;考虑n.(pl.)敬重,问候"],
...
["resort","[ri'zɔ:t] v.凭借,求助,诉诸n.度假胜地,常去之处,手段"],
...
["revolution","[,revə'lju:ʃən] n.革命;旋转,转数"],
["revolutionary","[,revə'lju:ʃənəri] a.革命的,革新的 n.革命者"],
...
["rifle","['raifl] n.步枪"],
["right","[rait] a.右的,正确的 n.右,权利ad.在右边,正确地"],
...
["round","[raund] a.圆的prep.围绕ad.在周围v.绕行n.(一)回合"],
...
["security","[si'kjuəriti] n.安全(感),防御(物),保证(人),(pl.)证券"],
...
["sign","[sain] n.标记,招牌;征兆,迹象v.签名(于),署名(于)"],
...
["somewhat","['sʌmhwɔt, -hwət] pron.&ad.一点儿，几分"],
...
["specification","[,spesifi'keiʃən] n.详述;(常pl.)规格,说明书,规范"],
...
["strap","[stræp] n.皮带，带子v.用带扣住，束牢;用绷带包扎"],
...
["studio","['stju:diəu, 'stu:-] n.画室;播音室;(电影)制片厂"],
...
["such","[sʌtʃ, sətʃ] a.这样的;上述的ad.那么pron.这样的人/事物"],
...
["Thanksgiving","n.感恩节"],
["that","[ðæt, 弱ðət, ðt] a./pron.那，那个 ad.那么 conj.[引导从句]"],
...
["them","[ðem, 弱ðəm, ðm] pron.他们/她们/它们(they的宾格形式)"],
...
["there","[ðεə, 弱ðə, ðr] ad.在那儿;往那儿;[作引导词表示\"\"存在\"\"]"],
...
["this","[ðis, 弱ðəs] pron.这(个) a.这(个);今 ad.这(样)"],
["thorn","[θɔ:n] n.刺,荆棘"],
...
["undergraduate","[,ʌndə'ɡrædjuət] n.大学生,大学肆业生"],
...
["watch","[wɔtʃ, wɔ:tʃ] v.观看;注视;看守;警戒 n.注视;手表;守护"],
...
["what","[hwɔt, hwʌt, 弱hwət] pron.什么 a.多么，何等;什么;尽可能多的"],
["whatever","[hwɔt'evə, 'hwət-] pron.无论什么 a.无论什么样的"],
["whatsoever","ad.(用于否定句中以加强语气)任何"],
["wheat","[hwi:t] n.小麦"],
["wheel","[hwi:l] n.轮,车轮"],
["when","[hwen, 弱hwən] ad./pron.何时;当时 conj.那时;然后;而"],
["whenever","[hwen'evə, hwən-] conj.无论何时,随时;每当"],
["where","[hwεə] ad.在哪/那里 conj./pron.哪里 conj.然而"],
["whereas","[hwεə'æz] conj.而,却,反之"],
["wherever","[hwεə'evə] conj.无论在哪里 ad.无论在哪里,究竟在哪里"],
["whether","['hweðə] conj.是否，会不会，不管，无论"],
...
["whom","[hu:m, 弱 hum] pron.谁;哪个人(who的宾格)"],
...
["withdraw","[wið'drɔ:, wiθ-] v.收回,撤消;缩回,退出;提取(钱)"],
...
["would","[wud, 弱wəd] aux./v.将;可能;将会;总是，总会;宁愿"],
...
["you","[ju:, 弱ju, jə] pron.你;你们;一个人，任何人"],
