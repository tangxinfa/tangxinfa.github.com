...
["abuse","n.滥用,虐待,辱骂,陋习;v.滥用,虐待,辱骂"],
...
["accommodation","n.住处,膳宿,(车,船,飞机等的)预定铺位,(眼睛等的)适应性调节,(社会集团间的)迁就融合"],
...
["aid","n.帮助,援助,帮助者,有帮助的事物;vt.资助,援助,帮助"],
["aisle","n.走廊,过道"],
["alarm","n.警报,惊慌,警告器;vt.恐吓,警告"],
["album","n.集邮本,照相簿,签名纪念册"],
["alcohol","n.酒精,酒"],
["alert","adj.提防的,警惕的;n.警惕,警报"],
...
["armor","n.装甲"],
["arouse","vt.唤醒,唤起,鼓励,引起;vi.睡醒"],
["arrange","v.安排,排列,协商"],
["arrangement","n.排列,安排"],
["array","n.排列,编队,军队,衣服,大批;vt.部署,穿着,排列"],
["arrest","vt.逮捕,拘留,吸引;n.逮捕,拘留"],
...
["attack","n.进攻,攻击,(用语言)抨击,批评,疾病发作,侵袭;vt.攻击,抨击,动手处理(某事);vi.攻击"],
["attain","vt.达到,获得;v.达到"],
...
["bamboo","n.竹子"],
["band","n.带子,镶边,波段,队,乐队;v.联合,结合"],
["bandage","n.绷带"],
["bang","n.重击,突然巨响;v.发巨响,重击"],
["banquet","n.宴会"],
["barely","adv.仅仅,刚刚,几乎不能"],
["bargain","n.契约,合同,成交商品,便宜货;v.议价"],
...
["beam","n.梁,桁条,(光线的)束,柱,电波,横梁;v.播送"],
["beforehand","adv.预先"],
["behave","vi.举动,举止,运转;v.行为表现"],
["behavior","n.举止,行为"],
["belly","n.腹部,胃;vi.涨满"],
["beneficial","adj.有益的,受益的,[法律]有使用权的;adj.有益的,得利的,[律]有使用权的"],
["benefit","n.利益,好处;vt.有益于,有助于;vi.受益"],
["betray","vt.出卖,背叛,泄露(秘密),露出...迹象"],
["bewilder","vt.使迷惑,使不知所措,使昏乱"],
["beyond","prep.在(到)...较远的一边,超过,那一边;adv.在远处;n.远处"],
["bibliography","n.(有关一个题目或一个人的)书目,参考书目"],
["biography","n.传记"],
["bizarre","adj.奇异的(指态度,容貌,款式等)"],
["blank","adj.空白的,空着的,失色的,没有表情的;n.空白,<美>表格"],
["blaze","n.火焰,光辉,情感爆发;vi.燃烧,照耀,激发;vt.在树皮上刻路标,公开宣布"],
["bleed","v.使出血,放血"],
["blink","v.眨眼,闪亮,无视"],
["blossom","n.花(尤指结果实者),花开的状态,兴旺期;vi.开花,兴旺,发展"],
...
["booth","n.货摊,售货亭,棚"],
["border","n.边界,国界,边,边沿,边境;vt.与...接壤,接近;v.接壤"],
["boring","n.钻(孔);adj.令人厌烦的"],
["bounce","v.(使)反跳,弹起,(指支票)被银行退票,弹跳;n.(球)跳起,弹回"],
["bound","n.跃进,跳,范围,限度;adj.正要启程的,开往...去的,被束缚的,装订的;v.跳跃,限制"],
["bowel","n.肠;adj.内部,同情心"],
["boycott","n.&vt.联合抵制,联合排斥某国货物或与某国绝交"],
["brace","n.支柱,带子,振作精神;vt.支住,撑牢,振作起来,奋起;adj.曲柄的;v.支持"],
["bracket","n.墙上凸出的托架,括弧,支架;v.括在一起"],
["brand","n.商标,牌子,烙印;vt.打火印,污辱"],
["breach","n.违背,破坏,破裂,裂口;vt.打破,突破"],
["breakdown","n.崩溃,衰弱,细目分类"],
["breakthrough","n.突破"],
["breed","v.(使)繁殖,教养,抚养;n.品种,种类"],
["brew","v.酿造,酝酿"],
["bribe","n.贿赂;vt.贿赂,向...行贿"],
["brief","n.摘要,大纲;adj.简短的,短暂的;vt.摘要,(军事)下达简令"],
["brilliant","adj.灿烂的,闪耀的,有才气的"],
["brink","n.(峭岸、崖的)边缘"],
["brisk","adj.敏锐的,凛冽的,轻快的,活泼的;vt.使活泼;vi.活跃起来"],
["bronze","n.青铜(铜与锡合金),铜像;adj.青铜色的"],
["brood","n.(动物中鸟或家禽的)一窝,(同种或同类的)一伙;vt.孵,沉思"],
["bruise","n.瘀伤,擦伤;v.打伤,撞伤"],
["brutal","adj.残忍的,兽性的"],
["buck","n.<美口>元,雄鹿,公羊,公兔;v.(马等)突然一跃(将骑手摔下)"],
["bud","n.芽,蓓蕾;vi.发芽,萌芽"],
["budget","n.预算;vi.做预算,编入预算"],
["bug","n.小虫,臭虫;v.装置窃听器,打扰"],
["bulk","n.大小,体积,大批,大多数,散装;vt.显得大,显得重要"],
["bull","n.[动]公牛,粗壮如牛的人"],
["bulletin","n.公告,报告"],
...
["burial","n.埋葬"],
["bust","n.半身像,胸像,(妇女的)胸部"],
["buzz","n.嗡嗡声;v.作嗡嗡声,嗡嗡作响,逼近"],
["bypass","n.旁路;vt.设旁路,迂回"],
["cabin","n.小屋,船舱"],
["cabinet","n.(有抽屉或格子的)橱柜,<美>内阁;adj.<美>内阁的,小巧的"],
["cable","n.电缆,海底电报,缆,索;v.打(海底)电报"],
["cafeteria","n.自助餐厅"],
...
["cancer","n.癌,毒瘤"],
["candidate","n.候选人,投考者"],
["cane","n.细长的茎,藤条;vt.以杖击,以藤编制"],
["cannon","n.大炮,加农炮;v.炮轰"],
["canon","n.教会法教规,教规,(基督教的)正典圣经(简称正经),一个作家的真作;日本佳能公司"],
["canvas","v.彻底讨论探究;n.帆布"],
["capable","adj.有能力的,能干的,有可能的,可以...的"],
["capacity","n.容量,生产量,容量,智能,才能,能力,接受力,地位"],
["cape","n.海角,岬"],
["capsule","n.(植物)蒴果,胶囊,瓶帽,太空舱"],
["caption","n.标题，说明,字幕;vt.加上标题,加上说明"],
["captive","n.俘虏,被美色或爱情迷住的人;adj.被俘的,被迷住的"],
["cardinal","n.枢机主教,红衣主教;adj.主要的,最重要的"],
["carve","v.雕刻,切开"],
["cast","n.投掷,铸件,脱落物,一瞥,演员表;v.投,抛,投射,浇铸,计算,派(角色)"],
["casual","adj.偶然的,不经意的,临时的"],
["casualty","n.伤亡"],
["catastrophe","n.大灾难,大祸"],
["cater","vi.备办食物,满足(需要),投合"],
["cathedral","n.大教堂"],
["catholic","n.天主教徒;adj.天主教的"],
["caution","n.小心,谨慎,警告;vt.警告"],
...
["champagne","n.香槟酒,香槟色"],
["champion","n.冠军,拥护者,战士;vt.拥护,支持"],
["chant","n.圣歌"],
["chapel","n.小礼拜堂,礼拜"],
["character","n.(事物的)特性,性质,特征(的总和),(人的)品质,字符,性格,特征,人物;vt.写,刻,印,使具有特征"],
["characteristi","adj.特有的,表示特性的,典型的;n.特性,特征"],
["characterize","vt.表现...的特色,刻画的...性格"],
["charge","n.负荷,电荷,费用,主管,掌管,充电,充气,装料;v.装满,控诉,责令,告诫,指示,加罪于,冲锋,收费"],
["chase","n.追赶,追击;vt.追赶,追逐,雕镂"],
["cherish","vt.珍爱,怀抱(希望等)"],
["chief","n.首领,领袖,酋长,长官,主要部分,最有价值的部分;adj.主要的,首要的,首席的,主任的"],
["chip","n.碎片,筹码;v.削成碎片,碎裂;芯片"],
["cholesterol","n.胆固醇"],
["chord","n.弦,和音,情绪;n.[解]腱"],
["chorus","n.合唱,合唱队,齐声"],
...
["clip","n.夹子,回形针,子弹夹;vt.夹住,剪短,修剪"],
["clockwise","adj.顺时针方向的;adv.顺时针方向地"],
["clone","n.无性系,无性繁殖,克隆;v.无性繁殖,复制"],
["closet","n.壁橱,储藏室,厕所;adj.关起门来的;vt.关入私室密谈"],
["clue","n.线索"],
["cluster","n.串,丛;vi.丛生,成群"],
...
["collide","vi.碰撞,抵触"],
["collision","n.碰撞,冲突"],
["colonial","adj.殖民的,殖民地的n.殖民地居民"],
["combat","n.战斗,格斗;v.战斗,搏斗,抗击"],
["combination","n.结合,联合,合并,化合,化合物"],
["combine","v.(使)联合,(使)结合;n.联合企业,联合收割机;n.联合收割机"],
["comet","n.彗星"],
...
["commission","n.委任,委托,代办(权),代理(权),犯(罪),佣金;vt.委任,任命,委托,委托制作,使服役"],
["commit","vt.犯(错误),干(坏事),把...交托给,提交,答应负责"],
["commitment","n.委托事项,许诺,承担义务"],
["committee","n.委员会"],
["commodity","n.日用品"],
["commonplace","n.平凡的事,平常话;adj.平凡的"],
["commonwealth","n.国民整体,共和国,联邦"],
...
["complement","n.补足物,[文法]补语,[数]余角;vt.补助,补足"],
...
["concept","n.观念,概念"],
["conception","n.观念,概念"],
["concern","vt.涉及,关系到;n.(利害)关系,关心,关注,关注,所关心的是"],
["concise","adj.简明的,简练的"],
["conclude","v.结束,终止,决定,作出结论;vt.推断,断定,缔结,议定"],
...
["conscious","adj.有意识的,有知觉的,故意的,羞怯的"],
...
["conservative","adj.保守的,守旧的;n.保守派"],
["conserve","vt.保存,保藏"],
...
["constituent","n.委托人,要素;adj.有选举权的；有宪法制定［修改］权的"],
...
["consume","vt.消耗,消费,消灭,大吃大喝,吸引;vi.消灭,毁灭"],
["consumer","n.消费者"],
...
["contend","v.斗争,竞争,主张"],
["contention","n.争夺,争论,争辩,论点"],
["contest","n.论争,竞赛;v.,争论,争辩,竞赛,争夺"],
...
["contrast","vt.使与...对比,使与...对照;vi.和...形成对照;n.对比,对照,(对照中的)差异"],
...
["convene","v.召集,集合"],
["convenience","n.便利,方便,有益,有用的,方便的用具、机械、安排等"],
["convention","n.大会,协定,习俗,惯例"],
["conventional","adj.惯例的,常规的,习俗的,传统的"],
["converge","v.聚合,集中于一点;vt.会聚"],
["conversion","n.变换,转化"],
["convert","n.皈依者;vt.使转变,转换...,使...改变信仰"],
["convey","vt.搬运,传达,转让"],
...
["cope","vi.(善于)应付,(善于)处理"],
["cord","n.绳索,束缚"],
["cordial","n.兴奋剂,兴奋性饮料;adj.热忱的,诚恳的,兴奋的"],
["cork","n.软木塞,软木,(用塞子)塞住"],
["corporate","adj.社团的,法人的,共同的,全体的"],
["corps","n.军团,兵队,团,兵种,技术兵种,特殊兵种,(德国大学的)学生联合会"],
["corpse","n.尸体"],
["correlate","vt.使相互关联;vi.和...相关"],
["correspondenc","n.相应,通信,信件"],
["corresponding","adj.相应的,通讯的"],
["corrode","v.使腐蚀,侵蚀"],
["corrupt","adj.腐败的,贪污的,被破坏的,混浊的,(语法)误用的;vt.使腐烂,腐蚀,使恶化;vi.腐烂,堕落"],
["costume","n.装束,服装"],
["council","n.政务会,理事会,委员会,参议会,讨论会议,顾问班子,立法班子"],
["counsel","n.讨论,商议,辩护律师;vt.劝告,忠告"],
["counter","n.计算器,计数器,计算者,柜台,筹码;adv.prep.相反地"],
["counterpart","n.副本,极相似的人或物,配对物"],
["coupon","n.息票,商家的优待券"],
["court","n.法院,庭院,朝廷,球场,奉承,求爱;vt.向...献殷勤,追求,博得(喝彩),招致(失败危险等);vi.求爱"],
["courtesy","n.谦恭,允许,礼貌"],
["coverage","n.覆盖"],
["coward","n.懦弱的人,胆小的人"],
["cozy","adj.舒适的,安逸的,惬意的"],
["cradle","n.摇篮,发源地,支船架;vt.将...放在摇篮内"],
["crash","n.碰撞,坠落,坠毁,撞击声,爆裂声;v.碰撞,坠落,坠毁,(指商业公司,政府等)破产,垮台"],
["creation","n.创造,创作物"],
["credible","adj.可信的,可靠的"],
["credit","n.信任,信用,声望,荣誉,[财务]贷方,银行存款;vt.相信,信任,把...归给"],
["crew","n.全体人员,(工作)队;vbl.crow的过去式"],
...
["criticism","n.批评,批判"],
["criticize","v.批评,责备"],
["crowd","n.人群,群众,一堆(东西),一伙;v.群集,拥挤,挤满"],
["crucial","adj.至关紧要的"],
...
["cycle","n.周期,循环,自行车,一段时间,整套,(电学)周波;vi.循环,轮转,骑自行车;vt.使循环,使轮转"],
["cylinder","n.圆筒,圆柱体,汽缸,柱面"],
["cynical","adj.愤世嫉俗的"],
["dart","n.标枪,镖,(昆虫的)刺,飞快的动作;v.飞奔,投掷"],
["database","n.[计]数据库,资料库"],
["dazzle","v.(使)眼花,眩耀;n.耀眼"],
["deadline","n.最终期限"],
["deadly","adj.致命的,势不两立的,死一般的,极度的,必定的"],
["dean","n.(大学)院长,主持牧师,(基督教)教长"],
["debate","v.争论,辩论;n.争论,辩论"],
["decade","n.十年,十"],
["decay","vi.&n.腐朽,腐烂,衰减,衰退;v.衰落"],
["deceive","v.欺骗,行骗"],
["decent","adj.正派的,端庄的,有分寸的,(服装)得体的,大方的;adj.<口>相当好的、象样的"],
["decimal","adj.十进的,小数的,以十为基础的,十进制;n.小数"],
["decisive","adj.决定性的"],
["decorate","v.装饰,为...做室内装修"],
["decrease","n.减少,减少之量;v.减少"],
["decree","n.法令,政令,教令,天命,判决;v.颁布"],
["dedicate","vt.献(身),致力,题献(一部著作给某人)"],
["deduce","vt.推论,演绎出"],
["deduct","vt.扣除,演绎"],
["deem","v.认为,相信"],
["default","n.默认(值),缺省(值),食言,不履行责任,[律]缺席;v.疏怠职责,缺席,拖欠,默认"],
["defeat","n.击败,战胜,失败;vt.击败,战胜,使失败,挫折;v.击败"],
["defect","n.过失,缺点"],
...
["deserve","vt.应受,值得;v.应受"],
["design","n.设计,图案,花样,企图,图谋,(小说等的)构思,纲要;v.设计,计划,谋划,构思"],
["designate","vt.指明,指出,任命,指派;v.指定,指派"],
["desirable","adj.值得要的,合意的,令人想要的,悦人心意的"],
["desire","vt.想望,期望,希望,请求(官方丈礼);n.愿望,心愿,要求;v.要求"],
["despise","vt.轻视"],
...
["detail","n.细节,详情;vt.详述,细说;"],
["detain","v.拘留,留住,阻止"],
["detect","vt.察觉,发觉,侦查,探测;v.发现"],
["detection","n.察觉,发觉,侦查,探测,发现"],
["detective","n.侦探;adj.侦探的"],
["deteriorate","v.(使)恶化"],
["deviate","vi.背离,偏离;v.偏离"],
["device","n.装置,设计,图案,策略,发明物,设备;[计]安装设备驱动程序"],
["devise","vt.设计,发明,图谋,作出(计划),想出(办法),遗赠给;n.遗赠"],
["devote","vt.投入于,献身"],
["diagnose","v.诊断"],
["dictate","v.口述,口授,使听写,指令,指示,命令,规定;n.指示(指理智,变心)"],
["differentiate","v.区别,区分"],
["digest","n.分类,摘要;vi.消化;vt.消化,融会贯通"],
["diffuse","v.散播,传播,漫射,扩散,(使)慢慢混合;adj.散开的,弥漫的"],
["dignity","n.尊严,高贵"],
["dilemma","n.进退两难的局面,困难的选择"],
["diligent","adj.勤勉的,用功的,细心而继续不断的"],
...
["discharge","vt.卸下,放出,清偿(债务),履行(义务),解雇,开(炮),放(枪),射(箭);vi.卸货,流注;n.卸货,流出,放电"],
...
["disgust","n.厌恶,嫌恶;vi.令人厌恶,令人反感;vt.使作呕"],
["dismay","n.沮丧,惊慌;v.使沮丧,使惊慌"],
["dismiss","vt.解散,下课,开除,解职,使(或让)离开;vi.解散"],
["disorder","n.杂乱,混乱,无秩序状态;vt.扰乱,使失调,使紊乱"],
["dispatch","vt.分派,派遣;n.派遣,急件"],
["disperse","v.(使)分散,(使)散开,疏散"],
["displace","vt.移置,转移,取代,置换;v.转移"],
["display","vt.陈列,展览,显示;n.陈列,展览,显示,显示器"],
...
["distinguish","v.区别,辨别"],
["distort","vt.弄歪(嘴脸等),扭曲,歪曲(真理、事实等),误报"],
["distract","v.转移"],
["distribution","n.分配,分发,配给物,销售,法院对无遗嘱死亡者财产的分配,分布状态,区分,分类,发送,发行"],
["disturbance","n.骚动,动乱,打扰,干扰,骚乱,搅动"],
["diverse","adj.不同的,变化多的"],
["diversion","n.转移,转换,牵制,解闷,娱乐"],
["divert","v.转移,转向,使高兴"],
["divine","adj.神的,神圣的,非凡的,超人的,非常可爱的;n.牧师"],
["divorce","n.离婚,脱离;vt.使离婚,与...脱离"],
["dizzy","adj.(指人)晕眩的,昏乱的,(指地点,情况)使人晕眩的"],
["dock","n.<美>码头,船坞,被告席,尾巴的骨肉部分;vt.靠码头,引入坞,剪短;vi.入船坞"],
["doctrine","n.教条,学说"],
["dodge","v.避开,躲避;n.<俗>诡计,躲藏"],
["dole","n.施舍品,悲哀,失业救济金;vt.发放救济"],
["dolphin","n.海豚"],
["domain","n.领土,领地,(活动、学问等的)范围,领域"],
["dome","n.圆屋顶"],
["domestic","adj.家庭的,国内的,与人共处的,驯服的"],
["dominant","adj.有统治权的,占优势的,支配的;adj.[生物]显性的"],
["dominate","v.支配,占优势"],
["donate","v.捐赠,赠予"],
["donation","n.捐赠品,捐款,贡献"],
["doom","n.厄运,毁灭,死亡,世末日;v.注定,判决;著名的3D动作游戏"],
["doubtless","adj.无疑的,确定的;adv.无疑地,确定地,<口>大概、多半"],
["draft","n.草稿,草案,草图;vt.起草,为...打样,设计;v.草拟"],
["drag","v.拖,拖曳,缓慢而费力地行动;n.拖拉"],
["drain","n.排水沟,消耗,排水;vt.排出沟外,喝干,耗尽;vi.排水,流干"],
["drainage","n.排水,排泄,排水装置,排水区域,排出物,消耗"],
["dramatic","adj.戏剧性的,生动的"],
["drastic","adj.激烈的,(药性等)猛烈的"],
["drawback","n.缺点,障碍,退还的关税,退税(指进口货物再出口时退还其进口时的关税)"],
["dread","n.恐惧,恐怖,可怕的人(或物),畏惧;v.惧怕,担心"],
["dreadful","adj.可怕的,<口>讨厌的"],
["drill","n.钻孔机,钻子,播种机,军事训练,操练,(反复)练习,条播机;v.训练,钻孔,条播"],
["drought","n.干旱,缺乏"],
["dual","adj.双的,二重的,双重"],
["dub","vt.[电影]配音,轻点,授予称号,打击;n.鼓声,笨蛋"],
["dubious","adj.可疑的,不确定的"],
["duplicate","adj.复制的,副的,两重的,两倍的,完全相同;n.复制品,副本;vt.复写,复制,使加倍,使成双"],
["dwarf","n.矮子,侏儒;v.(使)变矮小"],
["dwell","vi.居住,踌躇"],
["eagle","n.鹰,鹰状标饰"],
["Easter","n.[宗](耶稣)复活节"],
["eccentric","adj.古怪;n.行为古怪的人"],
["eclipse","n.食,日蚀,月蚀,蒙蔽,衰落;vt.引起日蚀,引起月蚀,超越,使黯然失色"],
["ecology","n.生态学,[社会]环境适应学,均衡系统"],
...
["electron","n.电子"],
["electronic","adj.电子的"],
["elegant","adj.文雅的,端庄的,雅致的,<口>上品的,第一流的"],
["element","n.要素,元素,成分,元件,自然环境"],
["elementary","adj.初步的,基本的,[化]元素的,自然力的"],
...
["embark","v.上船,上飞机,着手,从事,装于船上,登上"],
["embarrass","vt.使困窘,使局促不安,阻碍,麻烦"],
["embed","vt.使插入,使嵌入,深留,嵌入,[医]包埋"],
...
["engage","vt.使忙碌,雇佣,预定,使从事于,使参加;vi.答应,从事,交战,[机]接合,啮合"],
["engagement","n.约会,婚约,诺言,交战,接站,雇拥,[机]接合"],
["engine","n.发动机,机车,火车头"],
["enhance","vt.提高,增强;v.提高"],
["enlighten","vt.启发,启蒙,教导,授予...知识,开导,<古>照耀"],
["enormous","adj.巨大的,庞大的,<古>极恶的,凶暴的"],
["enrich","vt.使富足,使肥沃,装饰,加料于,浓缩"],
["enroll","v.[亦作enrol]登记,招收,使入伍(或入会、入学等),参加,成为成员"],
["ensue","vi.跟着发生,继起;vt.(基督教《圣经》用语)追求"],
["entail","vt.使必需,使蒙受,使承担,遗传给;n.[建]限定继承权"],
...
["environment","n.环境,外界"],
["envisage","v.正视"],
["epoch","n.新纪元,时代,时期,时间上的一点,[地质]世"],
["equality","n.等同性,同等,平等,相等,等式"],
["equator","n.赤道,赤道似的圈.圆"],
["equip","vt.装备,配备,训练,准备行装"],
["equivalent","adj.相等的,相当的,同意义的;n.等价物,相等物"],
["erect","adj.直立的,竖立的,笔直的;vt.盖,使竖立,使直立,树立,建立;vi.[生理]勃起"],
["erosion","n.腐蚀,侵蚀"],
["erroneous","adj.错误的,不正确的"],
["erupt","vt.喷出;vi.爆发"],
["escort","n.护卫(队),护送,陪同(人员),护卫队;v.护卫,护送,陪同"],
["essence","n.基本,[哲]本质,香精"],
["essential","adj.本质的,实质的,基本的,提炼的,精华的;n.本质,实质,要素,要点"],
...
["evident","adj.明显的,显然的"],
["evil","adj.邪恶的,带来麻烦的,不幸的,有害的,诽谤的;n.邪恶,不幸,罪恶"],
["evoke","vt.唤起,引起,博得"],
...
["excursion","n.远足,游览,短程旅行,远足队,离题,[物]偏移,漂移"],
["execute","vt.执行,实行,完成,处死,制成,[律]经签名盖章等手续使(证书)生效"],
["execution","n.实行,完成,执行,死刑,制作,(武器等的)破坏效果,杀伤力"],
["executive","adj.实行的,执行的,行政的;n.执行者,经理主管人员"],
["exemplify","vt.例证,例示,作为...例子"],
["exempt","v.免除;adj.被免除的"],
["exert","vt.尽(力),施加(压力等),努力;v.发挥,竭尽全力,尽"],
["exhaust","vt.用尽,耗尽,抽完,使筋疲力尽;vi.排气;n.排气,排气装置;adj.用不完的,不会枯竭的"],
["exhibit","vt.展出,陈列;n.展览品,陈列品,展品;v.展示"],
["exile","n.放逐,充军,流放,流犯,被放逐者;vt.放逐,流放,使背井离乡"],
["existence","n.存在,实在,生活,存在物,实在物"],
["exotic","adj.异国情调的,外来的,奇异的"],
["expand","vt.使膨胀,详述,扩张;vi.张开,发展"],
["expansion","n.扩充,开展,膨胀,扩张物,辽阔,浩瀚"],
["expedition","n.远征,探险队,迅速,派遣"],
["expel","v.驱逐,开除,排出,发射"],
["expend","vt.花费,消耗,支出,[海]把(暂时不用的绳)绕在杆上"],
["expenditure","n.支出,花费"],
["expense","n.费用,代价,损失,开支,费钱之物"],
["expert","n.专家,行家,[军](特等)射手;adj.老练的,内行的,专门的;vt.在...中当行家,当专家"],
["expertise","n.专家的意见,专门技术"],
["expire","v.期满,终止,呼气,断气,届满"],
["explicit","adj.外在的,清楚的,直率的,(租金等)直接付款的"],
["exploit","vt.开拓,开发,开采,剥削,用以自肥;v.使用"],
["explore","v.探险,探测,探究"],
["expose","vt.使暴露,受到,使曝光;v.揭露"],
["exposition","n.博览会,展览会,说明,曝露,[戏]展示部分,[音]呈示部"],
["expression","n.表达,表情,脸色,声调,腔调,榨出,语法,措辞;n.[数]式,表达式,符号"],
["exquisite","adj.优美的,高雅的,精致的,剧烈的,异常的,细腻的,敏锐的"],
["extensive","adj.广大的,广阔的,广泛的"],
["extent","n.广度,宽度,长度,范围,程度,区域,[律]<英>扣押,<美>临时所有权令"],
["external","adj.外部的,客观的,[医]外用的,外国的,表面的;n.外部,外面"],
["extinct","adj.熄灭的,灭绝的,耗尽的;vt.<古>使熄灭"],
["extinguish","vt.熄灭,消灭,压制,使黯然失色,偿清"],
["extract","n.精,汁,榨出物,摘录,选粹;vt.拔出,榨取,开方,求根,摘录,析取,吸取"],
...
["facet","n.(多面体的)面,(宝石等的)刻面,小平面,方面,琢面;vt.在...上刻画"],
...
["fantasy","n.幻想,白日梦"],
["fascinate","vt.使着迷,使神魂颠倒;vi.入迷,极度迷人的"],
...
["federal","adj.联邦的,联合的,联邦制的,同盟的;n.(南北战争)北部联邦同盟盟员;连邦软件公司,国内正版经销商"],
...
["fertilizer","n.肥料(尤指化学肥料),[动]受精媒介物"],
["fiction","n.虚构,编造,小说"],
["figure","n.外形,体形,图形,画像,数字,形状,身份;vt.描绘,塑造,表示,象征,演算,认为;vi.出现,考虑,出名,扮演角色"],
["finance","n.财政,金融,财政学;vt.供给...经费,负担经费;vi.筹措资金"],
["financial","adj.财政的,金融的"],
["finite","adj.有限的,[数]有穷的,限定的"],
["fitting","adj.适合的,相称的,适宜的;n.试穿,试衣,装配,装置"],
["fixture","n.固定设备,预定日期,比赛时间,[机]装置器,工作夹具"],
["flank","n.腰窝,侧面,军队侧翼,侧腹,胁,腰窝肉;vt.在...的侧面,侧翼包围,守侧面;vi.侧面与...相接"],
["flap","n.拍打,拍打声,副翼;v.拍打,鼓翼而飞,飘动,拉下(帽)的边,扔,掷"],
["flare","n.闪光,闪耀;vi.闪光,突然烧起来,闪耀;vt.使闪耀,使张开"],
["flask","n.瓶,长颈瓶,细颈瓶,烧瓶,小水瓶"],
["flat","adj.平坦的,扁平的,单调的,干脆的,无聊的;adv.平直地,正好,断然地;n.平面,一层,公寓;v.(使)变平,(使)降半音"],
["flatter","vt.过分夸赞,奉承,阿谀,使高兴,使满意,(画,肖像上的形象)胜过(真人或实物)"],
["flaw","n.缺点,裂纹,瑕疵,一阵狂风;vt.使破裂,使有缺陷,使无效;vi.生裂缝,变的有缺陷"],
["flexible","adj.柔韧性,易曲的,灵活的,柔软的,能变形的,可通融的"],
["fling","n.投,掷,猛冲,暴躁的行动,急冲,嘲弄,讥笑;vt.猛投,抛,掷,使陷入,挥动,嘲笑,扫视;vi.猛冲,直冲,急行"],
["flip","vt.掷,弹,轻击,鞭等抽打,空翻;vi.用指轻弹,抽打,翻书页(或纸张),蹦跳;n.抛,弹,筋斗;adj.无礼的,冒失的,轻率的"],
["float","n.漂流物,浮舟,浮萍,彩车;vi.浮动,飘浮,散播,摇摆,(计划等)付诸实行;vt.使漂浮,容纳,淹没,发行,用水注满"],
["fluctuate","vi.变动,波动,涨落,上下,动摇;vt.使动摇,使波动,使起伏"],
["flush","n.奔流,晕红,激动,萌芽,活力旺盛,发烧,一手同花的五张牌,惊鸟;adj.挥霍的,直接的,丰足的,泛滥的;adv.齐平地,直接地;vi.(脸)发红,奔涌,充沛,惊飞;vt.淹没,冲洗,使脸红,使齐平,使惊飞,使激动"],
["flutter","n.摆动,鼓翼,烦扰;vi.鼓翼,飘动,悸动,乱跳,烦扰;vt.拍(翅),使焦急"],
["foam","n.泡沫,水沫,泡沫材料,泡沫橡皮,泡沫塑料;vi.起泡沫,冒汗水,吐白沫;vt.使起泡沫"],
["focus","n.(兴趣活动)中心,焦点,焦距,[医]病灶,地],震源;vi.聚焦,注视;vt.使集中,在焦点上,定焦点,调焦,集中"],
["foil","n.箔,金属薄片,[建]叶形片,烘托,衬托;vt.衬托,阻止,挡开,挫败,贴箔于"],
["fold","n.折,羊栏,折痕,信徒;vt.折叠,包,合拢,抱住,笼罩,调入,交迭;vi.折叠起来,彻底失败"],
["force","n.力量,武力,精力,魄力,势力,暴力,[复]军队,影响力;vt.强制,强加,(用武力)夺取,使,推动,施加压力"],
["foremost","adj.(位置或时间)最先的,最初的,最重要的;adv.首要地,首先"],
["foresee","vt.预见,预知"],
["forge","v.稳步前进,铸造,伪造"],
["formal","adj.外形的,正式的,合礼仪的,形式的,整齐匀称的;n.正式的社交活动"],
["format","n.开本,版式,形式,格式;vt.安排...的格局(或规格),[计]格式化(磁盘)"],
...
["foster","vt.养育,抚育,培养,鼓励,抱(希望);n.养育者,鼓励者"],
["foul","adj.污秽的,邪恶的,恶劣的;vt.弄脏,妨害,污蔑,犯规;vi.腐烂,犯规,缠结;n.犯规,缠绕;adv.违反规则地,不正当地"],
...
["friction","n.摩擦,摩擦力"],
["fringe","n.边缘,须边,刘海;adj.边缘的,额外的;v.在...上加以缘饰,成为...的边缘"],
["fuel","n.燃料;vt.加燃料,供以燃料;vi.得到燃料"],
["fulfill","vt.履行,实现,完成(计划等)"],
["function","n.官能,功能,作用,职责,典礼,仪式,[数]函数;vi.(器官等)活动,运行,行使职责"],
["fund","n.资金,基金;v.支助,投资"],
["fundamental","adj.基础的,基本的;n.基本原则,基本原理"],
["furious","adj.狂怒的,狂暴的,激烈的,热烈兴奋的,极为激烈"],
...
["gamble","n.冒险;v.赌博,投机,孤注一掷"],
["garbage","n.垃圾,废物"],
["garment","n.衣服,外衣,外表"],
["gasp","vi.喘息,气喘;vt.气吁吁地说"],
["gauge","n.标准尺,规格,量规,量表;v.测量"],
["gaze","v.盯,凝视;n.凝视"],
["gear","n.齿轮,传动装置;v.调整,(使)适合,换档"],
...
["glance","vi.扫视,匆匆一看;n.一瞥,眼光,匆匆一看"],
["gland","n.[解剖]腺,[机械]密封管"],
["glare","n.眩目的光,显眼,怒目而视,(冰等的表面)光滑的表面;v.闪耀"],
["gleam","n.微弱的闪光,一丝光线,瞬息的一现;vi.闪烁,隐约地闪现;vt.使发微光,使闪烁"],
["glide","v.滑行,悄悄地走,(时间)消逝,滑翔;n.滑行,滑翔,滑移,滑音"],
...
["gossip","n.闲话,闲谈"],
["gown","n.长袍,法衣,礼服,睡袍"],
["gracious","adj.亲切的，和谐的；优美的；雅致的，雍容华贵的 int.（表示惊讶）天哪！"],
["graduate","n.(大学)毕业生,研究生;v.(使)(大学)毕业"],
...
["grip","vt.紧握,紧夹;n.掌握,控制,把手;v.抓住"],
["groan","n.呻吟,叹息;vi.呻吟,受折磨,受压迫发出嘎吱声;vt.呻吟着说"],
["groove","n.(唱片等的)凹槽,惯例,最佳状态;vt.开槽于"],
["grope","v.n.摸索"],
["gross","adj.总的,毛重的;n.总额"],
["guarantee","n.保证,保证书,担保,抵押品;vt.保证,担保"],
["guardian","n.护卫者,保护人,监护人;adj.守护的"],
["hamper","v.妨碍,牵制"],
["handbook","n.手册,便览"],
["handicap","n.障碍,阻碍,障碍赛跑;v.妨碍,使不利,阻碍"],
["hardy","adj.难的,艰苦的，勇敢的;adv.努力地,辛苦地,坚硬地"],
["harmony","n.协调,融洽"],
["hasty","adj.匆忙的,草率的"],
["hatch","n.孵化,舱口,舱口盖,(门、墙壁、地板上的)开口;vt.孵,孵出,策划,图谋;vi.孵化"],
["hatred","n.憎恨,乱意,仇恨"],
["haul","n.用力拖,拖拉,捕获物,努力得到结果,一网捕获鱼量,拖运距离;vi.拖,拉,改变方向,改变主意;vt.拖拉,拖运"],
["haunt","v.神鬼出没"],
["hawk","n.鹰,掠夺他人的人,鹰派成员;vi.放鹰,像鹰一般地袭击,清嗓,咳嗽;vt.捕捉,咳出,兜售,(沿街)叫卖,散播"],
["hazard","n.冒险,危险,冒险的事;vt.冒...的危险,赌运气,使遭危险"],
["heap","n.堆,大量,许多;vt.堆,堆起;v.堆积"],
["heave","v.举起;n.举起"],
["heel","n.脚后跟,踵,跟部"],
["heighten","v.提高,升高"],
["heir","n.继承人,后嗣"],
...
["hesitate","v.犹豫,踌躇,不愿"],
["hierarchy","n.层次,层级"],
["highlight","n.加亮区,精彩场面,最显著(重要)部分;vt.加亮,使显著,以强光照射,突出"],
...
["hose","n.软管,水龙带,长筒袜;v.用软管浇水"],
["hospitality","n.好客,宜人,盛情"],
["hostage","n.人质,抵押品"],
["hostile","adj.敌对的,敌方的;n.敌对"],
["hound","n.猎犬;vt.带猎犬狩猎,卑鄙的人,追捕,激励,使追逐"],
["household","n.一家人,家庭,家族,王室;adj.家庭的,家族的,家属的,普通的,平常的"],
["hover","v.盘旋"],
...
["humidity","n.湿气,潮湿,湿度<美>沼泽中的肥沃高地"],
["hurl","n.<俚>[棒球]用力或猛烈的投掷;vt.用力投掷,愤慨地说出,丢下,推翻;vi.猛投,猛掷"],
["hurricane","n.飓风,狂风"],
["hypothesis","n.假设"],
["hysterical","a歇斯底里的,异常兴奋的"],
["ideal","n.理想;adj.理想的,完美的,想象的,观念的,唯心论的"],
["identical","adj.同一的,同样的"],
["identificatio","n.辨认,鉴定,证明,视为同一"],
...
["immerse","vt.沉浸,使陷入"],
["immigrant","adj.(从外国)移来的,移民的,移居的;n.移民,侨民"],
["immune","adj.免疫的"],
["impact","n.碰撞,冲击,冲突,影响,效果;vt.挤入,撞击,压紧,对...发生影响"],
["impair","v.削弱"],
["impart","vt.给予(尤指抽象事物),传授,告知,透露"],
["impatient","adj.不耐烦的,急躁的,不耐心的"],
["imperative","n.命令,诫命,需要,规则,祈使语气;adj.命令的,强制的,紧急的,必要的,势在必行的,[语法]祈使的"],
["imperial","adj.皇帝的"],
["impetus","n.推动力,促进"],
...
["inaugurate","vt.举行就职典礼,创新,开辟,举行开幕(落成、成立)典礼."],
["incentive","n.动机;adj.激励的"],
["incidence","n.落下的方式,影响范围,[物理]入射"],
["incident","n.事件,事变;adj.附带的,易于发生的"],
["incidentally","adv.附带地,顺便提及"],
["incline","n.倾斜,斜坡,斜面;vt.使倾向于,使倾斜;vi.倾向,倾斜"],
["inclusive","adj.包含的,包括的"],
["incorporate","adj.合并的,结社的,一体化的;vt.合并,使组成公司,具体表现;vi.合并,混合,组成公司;vt.[律]结社,成为法人组织"],
...
["installment","n.部分"],
["instance","n.实例,建议,要求,情况,场合;vt.举...为例,获得例证"],
...
["intact","adj.完整无缺的,尚未被人碰过的,(女子)保持童贞的,(家畜)未经阉割的"],
["integral","adj.完整的,整体的,[数学]积分的,构成整体所需要的;n.[数学]积分,完整,部分"],
...
["intensive","adj.强烈的,精深的,透彻的,[语法]加强语气的;n.加强器"],
["intent","n.意图,目的,意向,[律](犯罪或侵权行为的)故意;adj.专心的,决心的,热心的"],
...
["interrupt","vt.打断(在说话或动作人),中断,妨碍,插嘴;vi.打断(别人的话或行动);n.(发给电脑的)中断信号"],
["intersection","n.[数]交集,十字路口,交叉点"],
["intervene","vi.干涉,干预,插入,介入,(指时间)介于其间;v.干涉"],
["intimate","adj.亲密的,隐私的;vt.宣布,明白表示;n.熟友"],
["intimidate","v.胁迫"],
...
["irrigation","n.灌溉,冲洗"],
["irritate","vt.激怒,使急躁;v.刺激"],
["isle","n.小岛,岛;vt.使成为岛屿;vi.住在岛屿上"],
["isolate","vt.使隔离,使孤立,使绝缘,离析;n.隔离种群"],
["issue","n.出版,发行,论点,问题,结果,(水血)流出;vi.发行,流出,造成...结果,辩护,传下;vt.使流出,放出,发钞,发令,出书;[律]子女,后嗣"],
["item","n.(可分类或列举的)项目,条款,(消息、情报等的)一则,一条"],
["ivory","n.象牙"],
["jeopardize","v.危害"],
["jerk","n.性情古怪的人,急推,猛拉,肌肉抽搐,(生理)反射,牛肉干;vi.痉挛,急拉,颠簸地行进;vt.猛拉"],
["jog","n.轻推,轻撞,漫步;v.轻推,(使)蹒跚行进,(使)慢跑"],
["junction","n.连接,接合,交叉点,汇合处"],
["junk","n.垃圾,舢板"],
["jury","n.[律]陪审团,评判委员会,陪审员;adj.[海]临时应急的"],
["keen","adj.锋利的,敏锐的,敏捷的,热心的,渴望的"],
["kidnap","vt.诱拐(小孩),绑架,勒赎"],
["kidney","n.肾,(动物可食用的)腰子,个性,性格"],
["kit","n.成套工具,用具包,工具箱,成套用具"],
["knit","v.编织,密接,结合"],
["knob","n.(门,抽屉等的)球形捏手,节,瘤,旋钮,球形突出物,(煤,砂糖等的)小块;vt.使有球形突出物;vi.鼓起"],
["label","n.标签,签条,商标,标志;vt.贴标签于,指...为,分类,标注;[计]加上或修改磁盘的标签"],
["lace","n.饰带,花边,缎带,鞋带;vt.扎带子,扎,饰以花边;vi.缚带子"],
["lame","adj.跛足的,僵痛的,不完全的,金属薄片,不知内情的人,(辩解、论据等)无说服力的;vi.变跛,瘸行;vt.使成残废"],
["lane","n.（乡间）小路,巷,里弄,狭窄的通道,航线"],
["lash","n.鞭子,鞭打,睫毛,责骂,讽刺;vt.鞭打,摆动,扎捆,冲击,煽动,讽刺;vi.猛击,急速甩动"],
["latent","adj.潜在的,潜伏的,隐藏的;n.隐约的指印"],
...
["linen","n.亚麻布,亚麻制品,亚麻纤维制成的优质纸;adj.亚麻布制的,亚麻的"],
["liner","n.<美>班机,划线者,衬垫"],
...
["litter","n.垃圾,(供动物睡眠或防冻用的)干草,树叶,(一)窝,轿,担架;vt.乱丢,铺草,弄乱;vi.产仔,乱丢垃圾"],
["locality","n.位置,地点"],
["locomotive","n.机车,火车头;adj.运动的"],
...
["majority","n.多数,大半;n.[律]成年"],
["mall","n.购物商场,商业街,林荫路"],
["management","n.经营,管理,处理,操纵,驾驶,手段"],
["maneuver","v.机动;n.机动"],
["manifest","n.载货单,旅客名单;adj.显然的,明白的;vi.出现;vt.表明,证明"],
["manipulate","vt.(熟练地)操作,使用(机器等),操纵(人或市价,市场),利用,应付,假造;vt.(熟练地)操作,巧妙地处理"],
["mansion","n.大厦,官邸,公寓(用复数,用于专有名词中)"],
["manual","n.手册,指南;adj.手的,手动的,手工的,体力的,手册(性质)的,[律]实际占有的"],
["manufacture","vt.制造,加工;n.制造,制造业,产品"],
["manufacturer","n.制造业者,厂商"],
["manuscript","n.手稿,原稿"],
["marble","n.大理石,(玩具)弹球.石弹子,雕刻品;adj.大理石的,冷酷无情的,坚硬的"],
["margin","n.页边的空白,(湖、池等的)边缘,极限,利润,差数,(时间、金额等的)富余;vt.加边于,加旁注于"],
["marginal","adj.记在页边的,边缘的,边际的"],
["marsh","n.湿地,沼泽,沼泽地"],
["marshal","n.元帅,典礼官,执行官,司仪官;vt.整顿,配置,汇集;vi.排列,集合"],
["masculine","adj.男性的,男子气概的,[语法]阳性的;n.男子,男孩"],
["mask","n.面具,掩饰,石膏面像;vt.戴面具,掩饰,使模糊;vi.化装,戴面具,掩饰,参加化装舞会"],
["mass","n.块,大多数,质量,群众,大量;adj.群众的,大规模的,集中的;vt.使集合;vi.聚集"],
["massacre","n.残杀,大屠杀;v.残杀,集体屠杀"],
["massive","adj.厚重的,大块的,魁伟的,结实的"],
["masterpiece","n.杰作,名著"],
["mature","adj.成熟的,到期的,充分考虑的,(票据等)到期的;vt.使成熟;vi.成熟,到期"],
["maximum","n.最大量,最大限度,极大;adj.最高的,最多的,最大极限的"],
["meadow","n.草地,牧场"],
...
["migrant","n.候鸟,移居者"],
["migrate","vi.移动,移往,移植,随季节而移居,(鸟类的)迁徙;vt.使移居,使移植"],
["mild","adj.温和的,温柔的,淡味的,轻微的,适度的,不含有害物质的的"],
["militant","adj.好战的,积极从事或支持使用武力的"],
["military","adj.军事的,军用的"],
["millionaire","n.百万富翁,大富豪"],
["mingle","v.(使)混合"],
["miniature","n.缩小的模型,缩图,缩影;adj.微型的,缩小的"],
["minibus","n.中客车,小型公共汽车(我国俗称面包车,乘员10人左右)"],
["minimal","adj.最小的,最小限度的"],
["minimize","vt.将...减到最少;v.最小化"],
...
["mistress","n.主妇,女主人,女能人,情妇"],
["moan","n.呻吟,哀悼,呼啸;vi.发出呻吟声,抱怨,哀悼;vt.呻吟"],
...
["monitor","n.班长,监听器,监视器,监控器;vt.监控;v.监控"],
["monopoly","n.垄断,垄断者,专利权,专利事业"],
["moral","n.怪物,妖怪"],
["monster","adj.道德(上)的,精神的;n.道德"],
["morality","adj.道德的;n.道德"],
["moreover","adv.而且,此外"],
["mortal","n.凡人,人类;adj.必死的,致命的,人类的,临终的;adj.<口>极端的,非常大(长)的"],
["mortgage","n.抵押;v.抵押"],
["motel","n.汽车旅馆"],
["motivate","v.激发"],
...
["murmur","n.低沉连续的声音,咕哝,怨言,低语;v.发低沉连续的声音,发怨言,低声说,低语"],
["muscular","adj.肌肉的,强健的"],
["mute","n.哑巴,哑音字母,[律]拒不答辩的被告,弱音器;adj.哑的,无声的,沉默的;vt.减弱...的声音;vi.排泄"],
...
["neglect","vt.忽视,疏忽,漏做;n.忽视,疏忽,漏做"],
["negligible","adj.可以忽略的,不予重视的"],
["negotiate","v.(与某人)商议,谈判,磋商,,买卖,让渡(支票、债券等),通过,越过"],
["neutral","n.中立者,中立国,非彩色,齿轮的空档;adj.中立的,中立国的,中性的,无确定性质的,(颜色等)不确定的"],
["nickel","n.[化]镍,镍币,(美国和加拿大的)五分镍币;vt.镀镍于"],
["nickname","n.诨号,绰号,昵称;vt.给...取绰号,给...起浑名"],
["nil","n.零"],
["nominal","adj.名义上的,有名无实的,名字的,[语]名词性的;n.名词性词"],
...
["notation","n.符号"],
["notify","v.通报"],
["notion","n.概念,观念,想法,意见,打算,主张,(复数)<美语>小饰物"],
["notorious","adj.声名狼籍的"],
["notwithstandi","prep.虽然,尽管;adv.尽管,还是;conj.虽然,尽管"],
["nourish","vt.滋养,使健壮,怀有(希望,仇恨等)"],
["novelty","n.新颖,新奇,新鲜,新奇的事物"],
["numerical","adj.数字的,用数表示的;adj.数字的,用数字表示的"],
...
["object","n.物体,目标,宾语,对象;vi.反对,拒绝,抗议;vt.提出...来反对"],
["objection","n.异议,缺陷,妨碍,拒绝之理由"],
["objective","n.目标,目的,(显微镜的)(接)物镜,[语法]宾格;adj.客观的,[语法]宾格的"],
["obligation","n.义务,职责,债务"],
["obscene","adj.淫秽的,猥亵的"],
["obscure","adj.暗的,朦胧的,模糊的,晦涩的;vt.使暗,使不明显"],
["obstacle","n.障碍,妨害物"],
["obtain","vt.获得,得到"],
["occasional","adj.偶然的,非经常的,特殊场合的,临时的"],
...
["offset","n.偏移量,抵销,弥补,分支,平版印刷,胶印;vt.弥补,抵销,用平版印刷;vi.偏移,形成分支"],
["offspring","n.(单复数同形)儿女,子孙,后代,产物"],
...
["orbit","n.轨道,势力范围,生活常规,眼眶;vt.绕...轨道而行;vi.进入轨道,沿轨道飞行,盘旋"],
["orchestra","n.管弦乐队,乐队演奏处"],
["ore","n.矿石,含有金属的岩石"],
["orient","n.东方,东方诸国(地中海以东各国);adj.东方的,上升的,灿烂的;vi.适应形势,向东;vt.使朝东,使适应,确定方向"],
["oriental","n.东方人(尤指中国人和日本人);adj.东方诸国的,亚洲的,东方的,(珍珠等)最优质的"],
["orientation","n.方向,方位,定位,倾向性,向东方"],
["origin","n.起源,由来,起因,出身,血统,[数]原点"],
["original","adj.最初的,原始的,独创的,新颖的;n.原物,原作"],
["originate","vt.引起,发明,发起,创办;vi.起源,发生"],
["ornament","n.装饰物,教堂用品;vt.装饰,修饰"],
["orthodox","adj.正统的,传统的,习惯的,保守的,东正教的"],
["outbreak","n.(战争的)爆发,(疾病的)发作"],
["outfit","n.用具,配备,机构,全套装配,;vt.配备,装备;vi.得到装备"],
...
["owl","n.[动]猫头鹰,枭,惯于晚上活动的人;ObjectWindowLibrary,BorlandC++的类库"],
["oxide","n.[化]氧化物"],
["oxygen","n.[化]氧"],
["ozone","n.新鲜的空气,[化]臭氧"],
["package","n.包裹,包"],
...
["pearl","n.珍珠"],
["peculiar","adj.奇特的,罕见的,特殊的;n.特有财产,特权"],
["pedal","n.踏板;v.踩...的踏板"],
["pedestrian","n.步行者;adj.徒步的,呆板的,通俗的"],
["peel","v.剥,削,剥落"],
["peg","n.钉,栓,桩,销子,借口;vt.钉木钉,固定,限制;vi.坚持不懈地工作"],
["penalty","n.处罚,罚款"],
["pendulum","n.钟摆,摇锤"],
["penguin","n.企鹅"],
["peninsula","n.半岛"],
...
["pessimistic","悲观的"],
["pest","n.有害物"],
["petition","n.请愿,情愿书,诉状,陈情书;v.请求,恳求,请愿"],
["petty","adj.小的,不重要的,小规模的,小型的,细微的,小器的,卑鄙的"],
["phase","n.阶段,状态,相,相位;v.定相"],
["phenomenon","n.现象"],
["physiological","adj.生理学的,生理学上的"],
["pilgrim","n.圣地朝拜者,朝圣"],
["pirate","n.海盗,盗印者,盗版者,侵犯专利权者;vt.盗印,盗版,掠夺,翻印;vi.做海盗"],
["pistol","n.手枪"],
["pitch","n.程度,斜度,树脂,投掷,定调,船前后颠簸,沥青;vt.投,掷,向前倾,定位于,用沥青涂,扎营;vi.搭篷,投掷,坠落,倾斜"],
["plague","n.瘟疫,麻烦,苦恼,灾祸;vt.折磨,使苦恼,使得灾祸"],
["planet","n.[天]行星"],
["plaster","n.石膏,灰泥,膏药,橡皮膏;vt.涂以灰泥,敷以膏药,减轻,粘贴,重创"],
["plateau","n.高地,高原(上升后的)稳定水平(或时期、状态)"],
["plausible","adj.似是而非的"],
["plea","n.恳求,请求,辩解,藉口"],
["plead","vbl.plead的过去式及过去分词"],
["pledge","n.保证,誓言,抵押,抵押品;vt.保证,使发誓,抵押,典当,举杯祝...健康"],
["plunge","n.跳进,投入;vi.投入,跳进,陷入;vt.使投入,使插入,使陷入"],
["poetry","n.诗,作诗法,诗意,诗情"],
["poisonous","adj.有毒的"],
["poke","n.刺,戳,懒汉,袋子;vt.戳,捅,拨开,刺;vi.戳,刺,捅,伸出,刺探,闲荡"],
["polar","adj.[天]两极的,极地的,南辕北辙的,南极的,(北极星似的)指引的,极性的,北极的;n.极线,极面"],
["pole","n.棒,柱,杆,竿,极,磁极,电极;vt.用竿支撑,用棒推;vi.撑篙"],
["polish","n.磨光,光泽,上光剂,优雅,精良;vt.擦亮,发亮,磨光,推敲;vi.发亮,变光滑;adj.波兰的;n.波兰人"],
["ponder","v.沉思,考虑"],
["pope","n.罗马教皇,主教,蒲柏(1688-1744,英国诗人),大腿上要害部位;vt.打大腿上要害部位"],
["porch","n.门廊,走廊"],
["pore","n.毛孔,小孔,气孔;vi.熟读,凝视,细想,沉思;vt.因凝视过度使...疲劳"],
["portray","v.描绘"],
["pose","n.姿势,姿态;v.(使...)摆好姿势,形成,引起,造成;vi.摆姿势,佯装,矫揉造作"],
["positive","adj.肯定的,实际的,积极的,绝对的,确实的;adj.[数]正的;adj.[电]阳的;adj.[语法]原级的"],
["possess","vt.占有,拥有,持有,摆布,支配"],
["posture","n.(身体的)姿势,体态,状态,情况,心境,态度;v.令取某种姿势,摆姿势,作出姿态"],
["potential","adj.潜在的,可能的,势的,位的;n.潜能,潜力,电压"],
...
["previous","n.事先查看,[计]预览;vt.事先查看,预展,预演"],
["preview","adj.在前的,早先的;adv.在...以前;返回上一级菜单"],
["prey","n.被掠食者,牺牲者,掠食;vi.捕食,掠夺,折磨"],
["priest","n.牧师"],
["primarily","adv.首先,起初,主要地,根本上"],
["primary","adj.第一位的,主要的,初步的,初级的,原来的,根源的"],
["prime","n.最初,青春,精华;adj.主要的,最初的,有青春活力的,最好的,第一流的,根本的,[数]素数的;v.预先准备好,<口>让人吃(喝)足,灌注,填装"],
["primitive","adj.原始的,远古的,粗糙的,简单的"],
["principal","n.负责人,首长,校长,主犯,本金;adj.主要的,首要的"],
["principle","n.法则,原则,原理"],
["priority","n.先,前,优先,优先权"],
["privacy","n.独处而不受干扰,秘密"],
["privilege","n.特权,特别待遇,基本公民权力,特免;vt.给与...特权,特免"],
["probability","n.可能性,或然性,概率"],
["probe","n.探针,探测器;vt.(以探针等)探查,查明"],
["procedure","n.程序,手续"],
["proceedings","n.行动,进行,会议录,学报"],
...
["protest","n.主张,断言,抗议;v.主张,断言抗议,拒付"],
["prototype","n.原型"],
["provided","conj.倘若"],
["provision","n.供应,(一批)供应品,预备,防备,规定"],
["provocative","adj.煽动的;n.刺激物"],
...
["pumpkin","n.南瓜"],
["purchase","vt.买,购买;n.买,购买"],
["purify","vt.使纯净;v.净化"],
["purity","n.纯净,纯洁,纯度"],
["pursue","vt.追赶,追踪,追击,继续,从事"],
["pursuit","n.追击"],
["qualitative","adj.性质上的,定性的"],
["quantify","vt.确定数量;v.量化"],
["quantitative","adj.数量的,定量的"],
["quart","n.夸脱(容量单位)"],
["quarterly","n.季刊;adj.一年四次的,每季的;adv.每季地"],
["quartz","n.石英"],
["queer","n.同性恋者;adj.奇怪的,可疑的，不舒服的;vt.搞糟;"],
["quench","vt.结束,熄灭，淬火;vi.熄灭,平息"],
["quest","n.寻求"],
["questionnaire","n.调查表,问卷"],
["quiver","n.震动,颤抖,箭袋,箭袋中的箭;vi.颤抖,振动,射中;vt.使颤动;adj.敏捷的"],
["quota","n.配额,限额"],
["racial","adj.人种的,种族的,种族间的"],
["racket","n.球拍,喧闹纷乱;v.过着花天酒地的生活"],
["radiant","adj.发光的,辐射的,容光焕发的"],
["radiate","vt.放射,辐射,传播,广播;vi.发光,辐射,流露;adj.有射线的,辐射状的"],
["radical","adj.根本的,基本的,激进的;n.激进分子"],
["radioactive","adj.放射性的,有辐射能的"],
["radius","n.半径,范围,辐射光线,有效航程,范围,界限"],
["random","n.随意,任意;adj.任意的,随便的,胡乱的;adv.胡乱地"],
["rank","n.等级,横列,阶级;adj.繁茂的,恶臭的,讨厌的,下流的;vt.排列,归类于,把...分等;vi.列为,列队;n.[数]秩"],
["rap","n.叩击,轻拍,轻敲,斥责;vt.敲,拍,厉声说出,斥责,使着迷;vi.敲击,交谈;abbr.[军]RocketAssistedProjectile,火箭助推炮弹"],
["rape","n.掠夺,强奸,葡萄渣,油菜;vt.掠夺,强奸"],
["rarely","adv.很少地,罕有地"],
["rash","adj.轻率的,匆忙的,卤莽的;n.[医]皮疹"],
["rating","n.等级级别(尤指军阶),额定,责骂,申斥"],
["rational","adj.理性的,合理的,推理的;n.[数]有理数"],
["reaction","n.反应,反作用,反动(力)"],
["readily","adv.乐意地,欣然,容易地"],
["realistic","adj.现实(主义)的"],
["reap","v.收割,收获"],
["reassure","vt.使...安心,再保证,使...恢复信心,打消...的疑虑"],
["rebel","n.造反者,叛逆者,反抗者,叛乱者;adj.造反的,叛逆的,反抗的;v.造反,反叛,反抗,叛乱"],
["rebellion","n.谋反,叛乱,反抗,不服从"],
["recall","vt.回忆,回想,记起,取消;n.召回"],
["recede","v.后退"],
["receipt","n.收条,收据,收到;v.收到"],
...
["recite","v.背诵,朗读,叙述,[律]书面陈述(事实)"],
["reckless","adj.不计后果的"],
["reckon","vt.计算,总计,估计,猜想;vi.数,计算,估计,依赖,料想"],
["reclaim","vt.要求归还,收回,开垦"],
["recognition","n.赞誉,承认,重视,公认,赏识,识别"],
["recognize","vt.认可,承认,公认,赏识;vi.具结"],
["reconcile","vt.使和解,使和谐,使顺从"],
["reconciliatio","n.和解,调和,顺从"],
["recover","vt.重新获得,恢复,使改过;vi.痊愈,复原,胜诉;n.DOS命令:从含有损坏磁盘扇区的磁盘上恢复文件"],
["recovery","n.恢复,痊愈,防御"],
["recreation","n.消遣,娱乐"],
["recruit","n.新兵,新分子,新会员;vt.使恢复,补充,征募;vi.征募新兵,复原"],
["rectangular","adj.矩形的,成直角的"],
["rectify","vt.矫正,调整,[化]精馏"],
["recur","vi.复发,重现,再来"],
["recycle","v.使再循环,反复应用;n.再循环,再生,重复利用"],
["redundant","adj.多余的"],
["reel","n.(棉纱,电线的)卷轴,(磁带等的)一盘,旋转,蹒跚;vt.卷...于轴上,使旋转;vi.蹒跚地走,旋转,眩晕,骚乱,退缩,摇晃"],
["referee","n.仲裁人,调解人,[体]裁判员;v.仲裁,裁判"],
["reference","n.提及,涉及,参考,参考书目,证明书(人),介绍信(人)"],
["reflect","v.反射,反映,表现,反省,细想"],
["reform","n.改革,改善,改良运动,感化;vt.改革,革新,重新组成;vi.革新,改过,重组"],
...
["register","n.记录,登记簿,登记,注册,寄存器;vt.记录,登记,注册,提示,把...挂号;vi.登记,注册,挂号"],
["regulation","n.规则,规章,调节,校准"],
["rehearsal","n.排演,演习,预演,试演"],
["reign","vi.统治,支配,盛行,占优势;n.统治,统治时期,支配"],
["rein","n.缰绳,统治,支配;vt.以缰绳控制,统治,驾驭;vi.勒住马,止住"],
["reinforce","vt.加强,增援,补充,增加...的数量,修补,加固;vi.求援,得到增援;n.加固物"],
["reject","n.被拒之人,被弃之物,不合格品,落选者,不及格者;vt.拒绝,抵制,否决,呕出,驳回,丢弃"],
["rejoice","v.(使)欣喜,(使)高兴,喜悦"],
["relative","n.亲戚,关系词,相关物,亲缘植物;adj.有关系的,相对的,比较而言的"],
["relay","n.驿马,接替,[电工]继电器;vt.(消息,货物等)分程传递,使接替,转播;vi.得到接替,转播"],
["release","n.释放,让渡,豁免,发行的书,释放证书;vt.释放,解放,放弃,让与,免除,发表;n.版本,发布"],
...
["religion","n.宗教,信仰"],
["religious","adj.信奉宗教的,虔诚的,宗教上的,修道的,严谨的;n.僧侣,尼姑,修道士"],
["relish","n.意味"],
["reluctant","adj.不顾的,勉强的,难得到的,难处理的"],
["rely","v.依赖,依靠,信赖,信任,依赖于"],
["remain","vi.保持,逗留,剩余,残存"],
["remainder","n.残余,剩余物,其他的人,[数]余数;v.廉价出售;adj.剩余的,出售剩书的"],
...
["revenge","n.报仇,复仇;vt.替...报仇,复仇"],
["revenue","n.收入,国家的收入,税收"],
["reverse","n.相反,背面,反面,倒退;adj.相反的,倒转的,颠倒的;vt.颠倒,倒转"],
...
["rim","n.边,轮缘,蓝框;vt.镶边,为...装边,沿...边缘滚动;vi.形成边状"],
...
["salute","n.(尤指军队等之)举手礼,升降旗致敬,呜礼炮等,敬礼;v.行礼致敬,敬礼"],
["salvation","n.拯救,救助"],
["sample","n.标本,样品,例子;vt.取样,采样,抽取...的样品,试验的一部分,尝试"],
["sanction","n.&v.批准,同意,支持,制裁,认可"],
["saturate","v.使饱和,浸透,使充满"],
["savage","adj.野蛮的,未开化的,凶猛的,残忍的;vt.用暴力对付;n.原始的人,粗鲁的人"],
...
["scent","n.气味,香味,香水,线索,嗅觉,臭迹;vt.闻出,嗅,发觉,循着遗臭追踪,使充满气味;vi.嗅猎,发出气味"],
...
["scrap","n.小片,废料,剪下来的图片,文章,残余物,废料,打架;vt.扔弃,敲碎,拆毁;vi.互相殴打;adj.零碎的,废弃的"],
...
["skull","n.头脑,头骨"],
["slack","n.松弛,静止,淡季,闲散;adj.松弛的,不流畅的,疏忽的,软弱的,漏水的,呆滞的,懒散的;adv.马虎地,缓慢地;vt.使松弛,使缓慢,马虎从事;vi.松懈,减弱,松驰"],
["slap","vt.拍,掌击,拍击;n.拍,掌击,拍击"],
["slash","v.猛砍,鞭打,砍伤,大量削减,严历批评,抽打;n.猛砍,(大幅度)削减,斜线"],
["slaughter","n.屠宰,残杀,屠杀;v.屠宰,残杀,屠杀"],
["slice","n.薄片,切片,一份,部分,片段;v.切(片)"],
["slick","adj.光滑的,熟练的,聪明的,华而不实的,陈腐的,平凡的;adv.灵活地,聪明地;vt.使光滑,使漂亮;n.平滑水面,平滑器,修光工具;vi.打扮整洁"],
["slide","v.(使)滑动,(使)滑行;n.滑,滑动,幻灯片"],
["slight","adj.轻微的,微小的"],
["slip","n.滑倒,事故,片,纸片;vi.滑动,滑倒,失足,减退;vt.使滑动,滑过,摆脱,闪开,塞入;adj.滑动的,活络的,有活结的;abbr.SerialLineInterfaceProtocol,串行线路接口协议,是旧式的协议"],
["slippery","adj.滑的,光滑的"],
["slogan","n.口号,标语"],
["slope","n.斜坡,斜面,倾斜;v.(使)顺斜"],
["slot","n.缝,狭槽,位置,水沟,细长的孔,硬币投币口,狭通道,足迹;vt.开槽于,跟踪"],
["slum","n.贫民窟;vi.访问贫民区"],
["slump","n.消沉,衰退,(物价)暴跌;v.失败,消沉,(物价)暴跌,跌落"],
["smash","v.打碎,粉碎;n.打碎,粉碎;adj.出色的"],
["smuggle","n.走私,偷带;v.走私"],
["snack","n.小吃,快餐,一份;v.吃快餐(小吃)"],
["snatch","v.攫取;n.攫取"],
["sneak","vi.鬼鬼祟祟做事;vt.偷偷摸摸做,<口>偷窃;n.鬼鬼祟祟人,偷偷摸摸行为,<美口>帆布胶底运动鞋;adj.暗中进行的"],
...
["span","n.跨度,跨距,范围;v.横越"],
["sparkle","v.发火花,(使)闪耀,(香槟酒等)发泡,用眼神表达,发光闪烁;n.火花,闪光,光彩,活力,发泡"],
["specialist","n.专门医师,专家"],
["specialty","n.专业"],
["species","n.种类,(原)核素;n.[律]式样;n.[宗]圣餐物"],
["specific","n.特效药,细节;adj.详细而精确的,明确的,特殊的,特效的,[生物]种的"],
["specification","n.详述,规格,说明书,规范"],
["spectacle","n.观览物,展览物,公开展示,奇观,景象,光景,(apairof～s)眼镜"],
["spectator","n.观众(指比赛或表演)"],
["spectrum","n.光,光谱,型谱,频谱"],
["speculate","vi.推测,思索,做投机买卖"],
["spice","n.香料,调味品,趣味,意味,情趣"],
["spine","n.脊骨,书脊,地面隆起地带,中心,剌"],
["spiral","adj.螺旋形的;n.螺旋;v.盘旋"],
["spite","n.(in～of)不顾,不管,敌意;v.困扰"],
["splash","n.溅,飞溅,斑点;v.溅,泼,溅湿"],
["spoil","vt.损坏,搞糟,宠坏,溺爱;v.扰乱"],
["sponge","n.海绵,(外科用的)棉球,纱布;v.用海绵冼涤,揩拭,清除,用海绵吸收(液体),(俗)依赖某人生活,诈取某人,海绵般吸收"],
["spontaneous","adj.自发的,自然产生的"],
["spouse","n.配偶(指夫或妻)"],
["sprinkle","v.撒(某物)于(某物之表面),洒,喷撒"],
["spy","n.特工人员,间谍,侦探,探员,秘密侦察他人行动者;v.侦察,侦察,发现"],
["squad","n.班"],
["stab","n.刺,刺伤的伤口,一阵突然而强烈的感觉,中伤,伤痛;v.剌,刺伤,伤害(感情等)"],
["stability","n.稳定性"],
["stabilize","v.稳定"],
["stable","adj.稳定的"],
...
["stereo","n.立体声系统,立体声,[印]铅版,立体照片;adj.立体的,立体感觉的"],
["stereotype","n.[印]铅版,陈腔滥调,老套;vt.使用铅版,套用老套,使一成不变"],
["stern","adj.严厉的,苛刻的;n.船尾"],
["sticky","adj.粘的,粘性的"],
["stimulus","n.刺激物,促进因素,刺激,刺激"],
["stock","n.树干,库存,股票,股份,托盘,祖先,原料;adj.股票的,普通的,常备的,存货的,繁殖用的;vt.装把手于,进货,备有,放牧;vi.出新芽,采购"],
["straightforwa","adj.正直的,坦率的,简单的,易懂的,直接了当的;adv.坦率地"],
["strain","n.过度的疲劳,紧张,张力,应变;vt.扭伤,损伤;v.拉紧,扯紧,(使)紧张,尽力"],
["strand","n.绳、线之一股,线,绳,串,海滨,河岸;vi.搁浅;vt.使搁浅,使落后,使陷于困境,弄断,搓"],
["strategy","n.策略,军略"],
["stray","v.迷路,偏离,漂泊,漂泊游荡;adj.迷路的,离群的,偶遇的"],
["streak","v.飞跑,加上条纹"],
["stream","n.溪,川,流,一股,一串,河流;v.流,涌,流注"],
["streamline","adj.流线型的"],
["stride","v.大步走(过),跨过,大步行走;n.步幅"],
["string","n.线,细绳,一串,一行;v.排成一列"],
["strive","v.努力,奋斗,力争,斗争"],
["stroke","n.击,敲,报时的钟声,(网球等)一击,(划船等)一划,(绘画等)一笔,一次努力,打击;vt.抚摸"],
...
["submarine","n.潜水艇,潜艇;adj.水下的,海底的"],
["submit","v.(使)服从,(使)顺从;vt.提交,递交"],
...
["surpass","vt.超越,胜过"],
["surplus","n.剩余,过剩,[会计]盈余;adj.过剩的,剩余的;vt.转让,卖掉"],
...
["symbol","n.符号,记号,象征"],
["symmetry","n.对称,匀称"],
["sympathetic","adj.有同情心的,合意的,赞成的;n.[解]交感神经,容易感受的人"],
["sympathy","n.同情,同情心"],
["symphony","n.交响乐,交响曲"],
["symposium","n.讨论会,座谈会"],
["syndrome","n.综合病症"],
...
["tackle","n.工具,复滑车,滑车,辘轱,用具,装备,扭倒;vt.固定,应付(难事等),处理,解决,抓住;vi.捉住,扭住,扭倒"],
["tame","adj.(动物)驯服的,柔顺的,(人)没精打彩的,顺从的,被开垦的,沉闷的,乏味的,平淡的;vt.驯养,驯服,制服,使变得平淡;vi.变得驯服"],
["tan","n.日晒后的颜色,棕褐色,茶色;adj.棕褐色的,茶色;v.晒黑,晒成褐色"],
["tangle","n.混乱状态;v.处于混乱状态"],
["tanker","n.油轮"],
["target","n.目标,对象,靶子"],
["tariff","n.关税,关税表,税则,(旅馆,饭店等的)价目表、价格表;vt.课以关税"],
["tease","n.揶揄,戏弄,逗惹;vt.取笑,逗恼,奚落,欺负,嘲弄,取笑,强求,梳理"],
["tedious","adj.单调乏味的,沉闷的,冗长乏味的"],
["telecommunica","n.电讯,长途通讯,无线电通讯,电信学"],
["temper","n.(钢等)韧度,回火,性情,脾气,情绪,心情,调剂,趋向;v.(冶金)回火、锻炼,调和,调节"],
...
["terrace","n.梯田的一层,梯田,房屋之平顶,露台,阳台,倾斜的平地;adj.(女服)叠层式的;vt.使成梯形地,使有平台屋顶"],
["terrain","n.地形"],
["terrific","adj.令人恐怖的"],
["terrify","vt.使恐怖,恐吓"],
...
["tickle","n.搔,胳肢,发痒;vt.胳肢,逗笑,使高兴,使发痒;vi.觉得痒,使人痒"],
["tile","n.瓦片,瓷砖"],
...
["toxic","adj.有毒的,中毒的"],
["tract","n.广阔的地面,土地,地方,地域,(解剖)管道,小册子"],
["trademark","n.商标"],
...
["tug","v.用力拖,吃力地搬运,苦干,用拖轮拖,拖拉;n.拖,苦干,拖船,(牵引用的)绳索"],
["tuition","n.学费"],
...
["unfold","vt.打开,显露,开展,阐明;vi.伸展,开花,呈现;vt.放(羊)出栏"],
["unity","n.团结,联合,统一,一致"],
["unique","adj.唯一的,独特的"],
["unity","n.团结,联合,统一,一致"],
["universe","n.宇宙,世界,万物,领域"],
["update","v.使现代化,修正,校正,更新;n.现代化,更新"],
["upgrade","n.升级,上升,上坡;adv.往上;vt.使升级,提升,改良品种"],
["uphold","vt.支持,赞成"],
["upright","adj.垂直的,竖式的,正直的,诚实的,合乎正道的;adv.笔直,竖立着;n.垂直,竖立"],
["urban","adj.城市的,市内的"],
["urge","vt.催促,力劝;n.强烈欲望,迫切要求;v.促进"],
["utilize","vt.利用"],
["utmost","n.极限,最大可能,极力;adj.极度的,最远的"],
["vacant","adj.空的,空白的,空灵的,头脑空虚的,神情茫然的,空闲的,空缺的"],
...
["vary","vt.改变,变更,使多样化;vi.变化,不同,违反"],
["vast","adj.巨大的,辽阔的,大量的,巨额的"],
["vegetation","n.[植]植被,(总称)植物、草木,(植物的)生长、呆板单调的生活"],
["vehicle","n.交通工具,车辆,媒介物,传达手段"],
["veil","n.面纱,面罩,帐,幕,掩饰物,遮蔽物,口实,假托;vt.戴面纱,隐藏,遮蔽,掩饰;vi.蒙上面纱"],
["vein","n.血管,静脉,叶脉,翅脉,矿脉,纹理,性情,心绪;vt.使成脉络,象脉络般分布于"],
["velocity","n.速度,速率,迅速,周转率"],
["velvet","n.天鹅绒,柔软,光滑;adj.天鹅绒的,柔软的,光滑的"],
["vent","n.通风孔,出烟孔,出口,(感情等的)发泄;v.放出,排出,发泄"],
["ventilate","vt.使通风,给...装通风设备"],
["venture","n.冒险,投机,风险;v.冒险,冒昧,斗胆,胆敢(谦语)"],
["verbal","adj.口头的"],
["verdict","n.[律](陪审团的)裁决,判决,判断,定论,结论"],
["verge","v.濒临;n.边缘"],
["verify","vt.检验,校验,查证,核实;[计]打开或关闭文件的读写校验"],
["versatile","adj.通用的,万能的,多才多艺的,多面手的"],
["verse","n.韵文,诗,诗节,诗句,诗篇"],
["version","n.译文,译本,翻译"],
["versus","prep.对(指诉讼,比赛等中),与...相对"],
["vertical","adj.垂直的,直立的,顶点的,[解]头顶的;n.垂直线,垂直面,竖向"],
["veto","n.否决,禁止,否决权;vt.否决,禁止"],
["vice","n.恶习,恶行,坏脾气,罪恶,堕落,老虎钳,缺点,缺陷;vt.钳住;prep.代替"],
["vicinity","n.邻近,附近,接近"],
["vicious","adj.恶的,不道德的,恶意的,刻毒的,堕落的,品性不端的,有错误的"],
["victim","n.受害人,牺牲者,牺牲品"],
["vigorous","adj.精力旺盛的,有力的,健壮的"],
["violate","vt.违犯,亵渎(圣物),冒犯,干扰,违反,妨碍,侵犯,强暴"],
["violent","adj.猛烈的,激烈的,暴力引起的,强暴的"],
["virgin","n.处女,处男;adj.处女的,童贞的,纯洁的,洁白无瑕疵的,未被玷污的,原始的,处于原状态的,未伐过的森林;美国游戏公司"],
["virtual","adj.虚的,实质的,[物]有效的,事实上的"],
["virtue","n.德行,美德,贞操,优点,功效,效力,英勇"],
["visa","n.签证;vt.签准;维萨信用卡"],
["vision","n.视力,视觉,先见之明,眼力,想象力,幻想,幻影,景象;vt.梦见,想象,显示"],
["visualize","vt.形象,形象化,想象;vi.显现"],
["vital","adj.生死攸关的,重大的,生命的,生机的,至关重要的,所必需的"],
["vivid","adj.生动的,鲜明的,鲜艳的,大胆的,清晰的,活泼的,逼真的"],
["vocal","adj.发嗓音的,声音的,有声的,歌唱的;n.元音,声乐作品"],
["vocational","adj.职业的"],
["void","n.空间,空旷,空虚,怅惘;adj.空的,无人的,空闲的,无效的,无用的,没有的"],
["volume","n.卷,册,体积,量,大量,音量"],
["voluntary","adj.自动的,自愿的,主动的,故意的,非官办的,志愿的,自发的"],
["volunteer","n.志愿者,志愿兵;adj.志愿的,义务的,无偿的;v.自愿"],
["vulgar","adj.粗俗的,庸俗的,普通的,通俗的,本土的;n.<古>平民,百姓"],
["vulnerable","adj.易受攻击的,易受...的攻击"],
["wallet","n.皮夹,钱夹,钓鱼带"],
["ward","n.守卫,保卫,保护,牢房,病房,行政区,监护,锁孔;vt.守护,保卫,防止,挡住,躲开,避免"],
["wardrobe","n.衣柜,衣厨,衣室,衣服,行头,剧装"],
["warehouse","n.仓库,货栈,大商店;vt.贮入仓库,<俚>[经]以他人名义购进(股票)"],
["warfare","n.战争,作战,冲突,竞争"],
["warrant","n.授权,正当理由,根据,证明,凭证,委任状,批准,许可证;vt.保证,辩解,担保,批准,使有正当理由"],
["watertight","adj.不漏水的,水密的"],
["watt","n.瓦特(1736-1819,英国工程师,发明家)"],
["wax","n.蜡,蜡状物,增加,月亮由亏转盈;vi.变大,增大,月亮渐满;vt.上蜡于"],
["wealth","n.财富,财产,大量"],
["wealthy","adj.富有的,丰裕的,充分的;n.富人,有钱人"],
["weapon","n.武器"],
["weary","adj.疲倦的,厌倦的,令人厌烦的,疲劳;v.疲倦,厌倦,厌烦"],
["web","n.网,蛛丝,蹼,翼手,织物,圈套,卷筒纸;vi.使陷入罗网,形成网;vt.织蜘蛛网于,使落入圈套;环球网"],
["wedge","n.楔;vt.楔入,楔进"],
["weird","adj.怪异的,超自然的,神秘的,不可思议的,超乎事理之外的;n.<古><苏格兰>命运,预言,符咒"],
["whereas","conj.然而,反之,鉴于,尽管,但是"],
["whereby","adv.凭什么,为何"],
["whirl","v.(使)旋转,急动,急走;n.旋转,—连串快速的活动"],
["withdraw","vt.收回,撤消;vi.缩回,退出;v.撤退"],
["withhold","vt.使停止,拒给,保留,抑制;vi.忍住"],
["witness","n.[律]证人,目击者,证据,证明,证词;vt.目击,为...作证,证明,表明;vi.作证,成为证据"],
["worthwhile","adj.值得做的,值得出力的"],
["worthy","n.杰出人物,知名人士;adj.有价值的,应...的,可敬的,值得的,相称的"],
["wreck","n.失事船(或飞机),残骸,(船,飞机的)失事;vt.破坏,拆毁"],
["wrench","n.扳钳,扳手,猛扭,痛苦,扭伤,歪曲;vt.猛扭,使扭伤,曲解,抢,折磨;vi.猛扭,绞痛"],
["wretched","adj.可怜的,悲惨的,肮脏的,恶劣的"],
["wrinkle","n.皱纹;v.使皱"],
["yacht","n.游艇,快艇,轻舟;vi.驾游艇,乘游艇"],
["yell","vi.大叫,忍不住笑,呼喊;vt.叫着说;n.叫声,喊声"],
["yield","v.出产,生长,生产;vi.(～to)屈服,屈从;n.产量,收益"],
["yoke","n.轭,轭状物,套,束缚,支配;v.把...套上轭,结合,连接"],
["zinc","n.锌;vt.涂锌"]
];
