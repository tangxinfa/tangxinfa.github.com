...
* LAMP WEB架构
  ...
  #+Caption: 四大金刚
  #+begin_src ditaa :file ../static/lamp_arch.png :cmdline -r -S
...
* Node.js WEB架构
  ...
  #+Caption: 三个好汉
  #+begin_src ditaa :file ../static/node_arch.png :cmdline -r -S
...
* Node.js 内部结构
  ...
  [[../static/node_structure.png]]
  
* 语言

  #+begin_quote
  完整的 =JavaScript= 实现由 =3= 个部分组成：
...
* 面向对象
  ...
  [[../static/woman_module.js][person.js]]
  #+ATTR_HTML: :textarea
...
* 闭包
  ...
  [[../static/woman_module.js][woman.js]]
  #+ATTR_HTML: :textarea
