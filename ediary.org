...
* DONE ediary已基本可用正式在个人博客中启用                          :ediary:
  ...
  经过上周末的一翻努力，参考 [medium](http://medium.com/) 的风格，对布局进行彻底的调整：
...
* DONE ediary支持主页以及完成国际化（i18n）支持                      :ediary:
  ...
  按照文章 [A strategy for i18n in node.js server templates](https://research.linagora.com/blog/?p=37) 的建议，选用 [i18n-node](https://github.com/mashpie/i18n-node) 做为国际化方案，顺利完成英文及中文简体的支持。
